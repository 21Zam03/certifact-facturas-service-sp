...
public class ComprobanteRequest {
    ...
    private List<GuiaRelacionadaRequest> guiasRelacionadas;
    ...
    private List<ComprobanteDetalleRequest> items;
    private String denominacionEmisor;
    private String nombreComercialEmisor;
    private String tipoDocumentoEmisor;
    private String identificadorDocumento;
    private String ordenCompra;
    private List<AnticipoRequest> anticipos;
    private List<CampoAdicionalRequest> camposAdicionales;
    private List<ComprobanteCuotaRequest> cuotas;
