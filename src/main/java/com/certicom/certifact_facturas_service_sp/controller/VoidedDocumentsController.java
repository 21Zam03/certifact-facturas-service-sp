...
public class VoidedDocumentsController {
    ...
    @PutMapping
    public ResponseEntity<?> update(@RequestBody VoidedDocuments voidedDocuments) {
        return new ResponseEntity<>(voidedDocumentsService.update(voidedDocuments), HttpStatus.OK);
    }
